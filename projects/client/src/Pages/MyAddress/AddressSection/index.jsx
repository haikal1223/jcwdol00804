        ...
        <div className="flex flex-col justify-center mx-20 my-10">
            ...
            {address.length > 0 ? (
                ...
                <div className="flex flex-col justify-center">
                    ...
                    {address.map(address => (
                        <div key={address.id}
                            className="block border rounded-md w-full bg-gray-100 p-3 mt-5 rounded shadow">
                            <div className="font-semibold">{address.address}</div>
                            <div>{address.city}, {address.province} {address.zipcode}</div>
            ...
            <Link to='/add-address'>
                <div className="flex justify-center">
                    <button
                        className="rounded-full bg-[#82CD47] w-8/12 h-[38px] text-white text-[22px] font-[600] shadow-md my-5">
                        Add Address
                    </button>
                </div>
            </Link>
