    ...
    <Page isFooter={false} isNavbar={false}>
      ...
      <div className="flex flex-col justify-center items-start">
        <div className="flex flex-col px-5 mt-2">
          {/* Card */}
          {location.state.shopName.map((val, idx) => {
            return (
              // Order Details and Delivery Details
              <div
                className="container rounded-xl shadow-md border h-min-[200px] w-[440px] py-3 mb-8"
                key={idx}
              >
                ...
                <div className="flex flex-col">
                  ...
                  <div className="px-5 max-h-[80px] mt-2 address">
                    ...
                    Inventore unde perspiciatis tempore amet, sunt culpa
                    reiciendis tempora aliquid assumenda maxime Lorem, ipsum.
                  </div>
                  <div className="flex flex-row justify-between items-center px-5 mt-4 mb-2">
                    <span className="text-[#6CC51D] font-bold">Courier</span>
                    <select className="w-[70%] border rounded-lg bg-slate-100 border-[#6CC51D] text-center cursor-pointer">
                      <option hidden>Select available courier</option>
                      <option>JNE YES - Rp 55.000 (ETA 1 day)</option>
                      <option>JNE REG - Rp 40.000</option>
                      <option>TIKI REG - Rp 38.000</option>
                    </select>
                  </div>
                </div>
              </div>
          ...
          <div className="container rounded-xl shadow-md border h-min-[200px] w-[440px] py-3 mb-2 ">
            ...
            <div className="flex flex-row justify-between px-5 mt-2">
              ...
              <span className="font-bold">
                Rp {(location.state.totalPrice - 20000).toLocaleString("id")}
              </span>
            </div>
          </div>
        </div>
