...
module.exports = {
  getCartList: (req, res) => {
    db.query(
      `SELECT x.user_id, y.*, z.name, z.description, z.price, z.stock, z.weight, z.category_id, z.product_img, z.is_delete, b.name as branch_name from cart x
  ...
  updateCartQuantity: async (req, res) => {
    ...
    const qty = await dbQuery(`SELECT quantity from cart_item WHERE id=${id}`);
    if (type === "increment") {
