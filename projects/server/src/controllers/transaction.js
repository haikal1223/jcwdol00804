...
module.exports = {
    // Super Admin
    orderListSuperAdmin: (req, response) => {
        const { inv, status, user_name, branch_name, start_date, end_date, order, sort_by, page } =
            req.query;
        let limit = 4;
    ...
    getOrderDetailSuperAdmin: (req, res) => {
        db.query(
    ...
    orderListBranchAdmin: (req, response) => {
        const { inv, status, user_name, start_date, end_date, order, sort_by, page } =
            req.query;
        let limit = 4;
        let offset = (page - 1) * limit;
        const result = () => {
